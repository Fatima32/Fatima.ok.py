...
except:ugen = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] #fatima
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] #fatima
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1mFATIMA
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m+92346×××××
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m.FUCK YOUR SYSTEM 
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #fatima
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/1TX.F4T1MA")
		exit()
	else:
		os.system("https://www.facebook.com/1TX.F4T1MA")
		exit()
...
def setting():
	...
	print("""%s \x1b[92;1m<===================================>\x1b[92;1m """%(h))
	CH0U9H4RY = input(x+'\33[1;96m•Input Number> : ')
	if CH0U9H4RY in ['1','01']:
		method.append('api')
	else:
		method.append('api')
